...
DROP VIEW IF EXISTS diting.mv_audit_host_behavior_rule_hourly;
...
DROP VIEW IF EXISTS diting.mv_audit_host_user_stats_hourly;
...
DROP TABLE IF EXISTS diting.audit_host_user_stats_hourly;
