import { CodeOutlined, DashboardOutlined, FileSearchOutlined, HddOutlined, SafetyCertificateOutlined, ThunderboltOutlined, UserOutlined } from '@ant-design/icons';
          ...
          items={[
            ...
            },
            {
              ...
              children: [
                ...
                { key: '/assets/hosts', icon: <HddOutlined />, label: '主机资产' },
              ],
            },
          ]}
        />
